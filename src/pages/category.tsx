...
function Category() {
    ...
    return (
        <div>
            ...
            <div className="grid bg-gradient-to-r from-green-200 to-blue-400 h-screen">
                <div className="grid md:flex grid-cols-1 pe-4 md:pe-0 ">
                    <div className="sticky top-20 w-full md:mt-10 bg-slate-300 border-2 border-purple-800 md:m-auto m-2 md:mx-2 p-2 md:px-10 rounded-lg text-center">
                    ...
                    <div className="w-full  md:mt-10 bg-slate-300 border-2 border-purple-800 md:m-auto m-2 md:mx-2 p-2 md:px-10 rounded-lg text-center ">

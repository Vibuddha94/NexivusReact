                                    ...
                                    {newProducts.map(function (product) {
                                        return (<tr className="bg-white border-2 border-white border-2 border-violet-600">
                                            ...
                                            <td className="pe-4 py-4 text-right flex gap-2 border-violet-600">
                                                <input type="text" onClick={()=>{setProductId(product.id)}} onChange={(e)=>{setQty(parseInt(e.target.value))}} className="mx-2 px-2 rounded-xl text-center w-20 border-2" placeholder="Quantity" />
                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        <tr className="bg-white border-2 border-white border-2 border-violet-600">
                                            ...
                                            <td className="pe-4 py-4 text-right flex gap-2 border-violet-600">
                                                <input type="text" className="mx-2 px-2 rounded-xl text-center w-20 border-2" placeholder="Quantity" />
                                        ...
                                        <tbody>
                                            <tr className="bg-white border-2 border-white border-2 border-violet-600">
                                                ...
                                                <td className="pe-4 py-4 text-right border-2 border-violet-600">
                                                    <button type="button" className="w-20 py-1 bg-gradient-to-br from-red-800 to-pink-500 md:mt-0 mt-2 rounded-xl border-2 border-yellow-400 text-white font-semibold hover:bg-gradient-to-l hover:border-black">DELETE</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
